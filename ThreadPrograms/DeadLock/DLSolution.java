class DLSolution extends Exception{                                                       // Properties of Exception class is Inherited by the current class(i.e. DLSolution)
	
	public static DLSolution Resrc1 = new DLSolution();                                   // Creating 1st Object of current class(i.e. DLSolution)
	public static DLSolution Resrc2 = new DLSolution();                                   // Creating 2st Object of current class(i.e. DLSolution)
	
	private static class Thread1 extends Thread{                                 // Sub-class Thread1 Declared to be private & is Created with Inherited Properties of Thread class 
	...
	private static class Thread2 extends Thread{                                 // Sub-class Thread2 Declared to be private & is Created with Inherited Properties of Thread class 
	...
	public static void main(String args[]){
		...
		Thread2 t2 = new Thread2();                                                       // Creating Object of Thread1 as t2
		
		t1.start();                                                                      // Calling start() method of Thread1 using t1
		t2.start();                                                                      // Calling start() method of Thread1 using t2 
